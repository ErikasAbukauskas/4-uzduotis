...
class ContactController extends Controller
{
    ...
    public function show(Contact $contact)
    {
        ...
        $companies = $contact->companyContact;
    ...
    public function destroy(Contact $contact, Request $request)
    {
        ...
        $companies_count = $contact->companyContact->count();


        if($companies_count!=0) {
            return redirect()->route("contact.index")->with('error_message', 'Negalima istrinti, nes companija turi tipu');
        }


        $contact->delete();
        return redirect()->route("contact.index")->with('success_message','Istrinta sekmingai');
    }
}
